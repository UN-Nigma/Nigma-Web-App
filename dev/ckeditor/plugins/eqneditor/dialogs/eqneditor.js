...
CKEDITOR.dialog.add("eqneditorDialog", function(b) {
    ...
    window.CCounter++;
    return {
        title:b.lang.eqneditor.title, minWidth:550, minHeight:380, resizable:CKEDITOR.DIALOG_RESIZE_NONE, contents:[ {
